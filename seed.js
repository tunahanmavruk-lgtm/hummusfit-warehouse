...
const seed = db.transaction(() => {
  ...
  // Build lanes: 3 rows per section, 27 positions per row.
  ...
  // Auto-assign products to lanes: bakery section gets muffin/oats/snack sorted
  // by velocity desc, meals section gets meal sorted by velocity desc. This is a
  // starting point — reassignment happens through the app, not by re-seeding.
